...
extern const MIDL_SERVER_INFO SysmonClipboard_ServerInfo;

extern const RPC_DISPATCH_TABLE SysmonClipboard_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE SysmonClipboard___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x12345678,0x1234,0x1234,{0x12,0x34,0x12,0x34,0x56,0x78,0x9A,0xBC}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&SysmonClipboard_v1_0_DispatchTable,
    0,
    0,
    0,
    &SysmonClipboard_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE SysmonClipboard_v1_0_s_ifspec = (RPC_IF_HANDLE)& SysmonClipboard___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const MIDL_STUB_DESC SysmonClipboard_StubDesc = 
    {
    (void *)& SysmonClipboard___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION SysmonClipboard_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE SysmonClipboard_v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)SysmonClipboard_table
    };

static const SERVER_ROUTINE SysmonClipboard_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)SysmonClipboardRegister,
    (SERVER_ROUTINE)SysmonClipboardSend
    };

static const MIDL_SERVER_INFO SysmonClipboard_ServerInfo = 
    {
    &SysmonClipboard_StubDesc,
    SysmonClipboard_ServerRoutineTable,
    SysmonClipboard__MIDL_ProcFormatString.Format,
    SysmonClipboard_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
